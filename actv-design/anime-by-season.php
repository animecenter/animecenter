    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                <div class="row">
                    <div class="col-xs-12 col-md-8">
                         ...
                         <button type="button" class="btn btn-purple btn-circle menufilter">
                                <i class="fa fa-th"></i>
                            </button>
                            <button type="button" class="btn btn-purple btn-circle menufilter">
               ...
               <div class="btn-group menufilter">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            <li><a href="#"><i class="fa fa-asterisk fa-fw text-lightblue"></i> Winter Season</a></li>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <a class="thumbnail" href="#">
                                    ...
                                    <span class="titleanimeseason">Gatchaman Crowds Insight</span>
                                </a>
                            </div>
                            <div class="col-md-3">
                                <a class="thumbnail" href="#">
                                    <img alt="" src="public/img/anime/74683.jpg">
                                    <span class="titleanimeseason">
                    ...
                    <div class="col-xs-12 col-md-4">
                        <h1 class="page-header">
                            <i class="fa fa-thumbs-up fa-fw text-lightblue"></i> Like Us
                        </h1>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <a class="thumbnail" href="#">
                                        <img alt="" src="public/img/anime/73852.jpg">
                                        <span class="titleanimeseason">Gatchaman Crowds Insight</span></a>
                                </div>
                                <div class="col-md-3">
                                    <a class="thumbnail" href="#">
                                        <img alt="" src="public/img/anime/74683.jpg">
...
>>>>>>> 9b84af062b90e425c29a82d28842829ed9d21d65
                    </div>
                </div>
            </div>
