   ...
   <?php include_once("banner.php");?>
       <div id="left_content">
        <div id="sec3" class="sections">
         ...
         <div class="main_title"><?php echo (strlen($series['a_title'])<13)?$series['a_title']:substr($series['a_title'],0,13)."..."; ?></div>
         </div><!--/block-->
         </a>
           <?php } ?>
            <div class="pagination" <?php if($num_pages<=1){echo "style='display:none'";}?>>
					  ...
					  ?>
                       <?php if(isset($_GET['offset']) and $_GET['offset']>1){ ?><a href="<?php echo $url; ?>latest-anime" title="First Page">&laquo; First</a><?php }?>
