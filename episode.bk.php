                                ...
                                <div class="block">
                                    <a href="<?php echo $main_link; ?>">
                                        ...
                                        echo ( ! (isset($type[2])) or $type[2] == '') ? ' active' : ''; ?>">
                                            English <?php echo $ser['a_type2']; ?></div>
                                    </a>
                                </div><!--/block-->
                            <?php } ?>
                            <?php if ($episode_content['e_mirror1'] != null or $episode_content['e_mirror1'] != '') { ?>
                                <div class="block">
                                    <a href="<?php echo $main_link; ?>/mirror1">
                                        <div class="tab <?php echo $ser['a_type2'];
                                        echo (isset($type[2]) and $type[2] == 'mirror1') ? ' active' : ''; ?>">Mirror 1
                                        </div>
                                    </a>
                                </div><!--/block-->
                            <?php } ?>
                            <?php if ($episode_content['e_mirror2'] != null or $episode_content['e_mirror2'] != '') { ?>
                                <div class="block">
                                    <a href="<?php echo $main_link; ?>/mirror2">
                                        <div class="tab <?php echo $ser['a_type2'];
                                        echo (isset($type[2]) and $type[2] == 'mirror2') ? ' active' : ''; ?>">Mirror 2
                                        </div>
                                    </a>
                                </div><!--/block-->
                            <?php } ?>
                            <?php if ($episode_content['e_mirror3'] != null or $episode_content['e_mirror3'] != '') { ?>
                                <div class="block">
                                    <a href="<?php echo $main_link; ?>/mirror3">
                                        <div class="tab <?php echo $ser['a_type2'];
                                        echo (isset($type[2]) and $type[2] == 'mirror3') ? ' active' : ''; ?>">Mirror 3
                                        </div>
                                    </a>
                                </div><!--/block-->
                            <?php } ?>
                            <?php if ($episode_content['e_mirror4'] != null or $episode_content['e_mirror4'] != '') { ?>
                                <div class="block">
                                    <a href="<?php echo $main_link; ?>/mirror4">
                                        <div class="tab <?php echo $ser['a_type2'];
                                        echo (isset($type[2]) and $type[2] == 'mirror4') ? ' active' : ''; ?>">Mirror 4
                                        </div>
                                    </a>
                                </div><!--/block-->
                            <?php } ?>
                            ...
                            <?php if ($episode_content['e_hd'] != null or $episode_content['e_hd'] != '') { ?>
                                <div class="block">
                                    <a href="<?php echo $main_link; ?>/hd">
                                        <div class="tab <?php echo $ser['a_type2'];
                                        echo (isset($type[2]) and $type[2] == 'hd') ? ' active' : ''; ?> mirror">Mirror
                                            HD
                                        </div>
                                    </a>
                                </div><!--/block-->
