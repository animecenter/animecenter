...
<iframe id='aab15dd6' name='aab15dd6' src='http://www.postads24.com/afr.php?zoneid=6774&amp;cb=INSERT_RANDOM_NUMBER_HERE' frameborder='0' scrolling='no' width='728' height='90'><a href='http://www.postads24.com/ck.php?n=af9515e8&amp;cb=INSERT_RANDOM_NUMBER_HERE' target='_blank'><img src='http://www.postads24.com/avw.php?zoneid=6774&amp;cb=INSERT_RANDOM_NUMBER_HERE&amp;n=af9515e8' border='0' alt='' /></a></iframe>
<!----Tagsrv--------------------------------------------------></div>
<div class="widget" id="featured"  style="width:245px; margin-left:3px;">   
    <div class="block">
     <a href="<?php echo $link;?>">
    <img class='eimg' src="<?php echo $image; ?>" />
    <div class="sub_title" style="width:170px;"><?php echo (strlen($s_ser['a_title'])<20)?$s_ser['a_title']:substr($s_ser['a_title'],0,20)."..."; ?></div>
     </a>
     <div class='rateContainor'  style='width:170px;;margin-top:5px;float:left'>
               <div style='float:left;' value="<?php echo $s_ser['a_rating']; ?>" id="<?php echo $s_ser['a_id']; ?>" class='rateDiv'></div> 
              <div style='float: left; font-size: 8pt;  width: 100%; display:none' id='hint<?php echo $s_ser['a_id']; ?>' > </div><div
			  id='hint2<?php echo $s_ser['a_id']; ?>' style='width:100%;font-size:8pt;float:left'>   <?php echo "Average: ". sprintf ("%.2f",$s_ser['a_rating'])." ( ". $s_ser['a_votes']." votes)"  ?> </div>
                </div>
    </div><!--/block-->
</div><!--/featured-->
<script>
