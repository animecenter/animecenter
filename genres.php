...
<div id="wrap">
   ...
   <?php include_once("banner.php");?>
       <div id="left_content">
        ...
        <div class="content">
            Select Anime Genre(s) from the boxes, and click "Search" button. For Example: You like Action, Adventure and Martial Arts Anime, select the genres and go! Thats all. 
         </div>
        ...
        <div class="block">
            ...
            <div class="label">Items containing: </div>
               <div class="radio_block"> <input type="radio" name="scope" value="all" checked="checked" /><span></span><label><strong>All</strong> Terms</label></div>
                <div class="radio_block"> <input type="radio" name="scope" value="any" /><span></span><label><strong>Any</strong> Terms</label></div>
            </div><!--/cont-->
        </div><!--/block-->
        ...
        <div class="block">
            ...
            <?php while($gen=mysql_fetch_assoc($genres)){?>
               <div class="box_block">  <input type="checkbox" name="genres[]" value="<?php echo $gen['g_value']; ?>" />
               <span></span>
