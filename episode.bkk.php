...
default:$cont=($episode_content['e_hd']==NULL)?$episode_content['e_raw']:$episode_content['e_hd'];
}//end switch
}//end if type
else $cont=($episode_content['e_hd']==NULL)?$episode_content['e_raw']:$episode_content['e_hd'];
?>
<div id="wrap">
   <div id="content">
