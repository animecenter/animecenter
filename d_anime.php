                ...
                <a href="<?php echo $link; ?>">
                    <div class="block">
                        <a href="<?php echo $link; ?>">
                            ...
                            <div class="sub_title">
                                <?php echo (strlen($series['a_title']) < 20) ? $series['a_title'] :
                                    substr($series['a_title'], 0, 20) . "..."; ?>
                            </div>
                        </a>
                        <div class='rateContainor' style='width:220px;;margin-top:5px;float:left'>
                            <div style='float:left;' value="<?php echo $series['a_rating']; ?>"
                                 id="<?php echo $series['a_id']; ?>" class='rateDiv'>
                            </div>
                            <div style='float: left; font-size: 8pt;  width: 100%; display:none' id='hint<?php echo $series['a_id']; ?>'></div>
                            <div id='hint2<?php echo $series['a_id']; ?>' style='width:100%;font-size:8pt;float:left'>
                                <?php echo "Average: " . sprintf("%.2f", $series['a_rating']) .
                                    " ( " . $series['a_votes'] . " votes)" ?>
                            </div>
                        </div>
                    </div>
                    <!--/block-->
