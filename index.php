                ...
                <?php if (count($images_list > 0)) { ?>
                    ...
                    <div class="slide">
                        ...
                        <div class="pagination">
                            <div class="content">
                                <div class="bigtitle">
                                    <?php echo $images_list[0]['i_bigtitle']; ?>
                                </div>
                                <div class="smalltitle">
                                    <?php echo $images_list[0]['i_smalltitle']; ?>
                                </div>
                                <div class="desc">
                                    <?php echo $images_list[0]['i_desc']; ?>
                                </div>
                ...
                foreach ($episodes_list as $episode) {
                    ...
                    <a href="<?php echo $link; ?>">
                        <div class="block <? echo $pad ?>">
                            <div
                                class="main_title">
                                <?php echo (strlen($ser['a_title']) < 20) ?
                                    $ser['a_title'] :
                                    substr($ser['a_title'], 0, 20) . "...";
                                ?>
                            </div>
                            <?php
                            $sn = $ser['a_title'];
            ...
            <div id="sec3" class="sections">
                ...
                <div class="pagination" <?php if ($num_pages <= 1) {
                    ...
                    <?php if ( ! isset($_GET['offset']) or $_GET['offset'] < $num_pages) { ?>
                        <a href="?offset=<?php echo $next; ?>" title="Next Page">Next &raquo;</a>
                    <?php } ?>
                    <?php if ( ! isset($_GET['offset']) or $_GET['offset'] < $num_pages) { ?>
                        <a href="?offset=<?php echo $num_pages; ?>" title="Last Page">Last &raquo;</a>
                    <?php } ?>
                </div>
                <!-- End .pagination -->
            </div>
