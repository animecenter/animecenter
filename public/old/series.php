            ...
            <div class="sec_top_one">
                <div class="fb-like" style="height:30px;"
                     data-href="<?php echo $url . $series_content['a_type2'] . "-anime/" . str_replace(" ", "-",
                             strtolower($series_content['a_title'])); ?>" data-width="450" data-show-faces="false"
                     data-send="true"></div>
                <?php if (isset($_SESSION['u_username'])) { ?>
                    <a href="<?php echo $url; ?>admin/index.php?page=series_up&id=<?php echo $series_content['a_id']; ?>"
            ...
            <div class="sections" id="series">
                <div class="series">
                        ...
                        <div class="login">
                            <?php if (isset($_SESSION['u_username'])) { ?>
                                <select class="member-select episodess">
                                    ...
                                    <option
                                        value="<?php echo $url; ?>admin/index.php?page=episode_add&id=<?php echo $series_content['a_id']; ?>">
                                        Add Episode Manually
                                    </option>
                                    <option value="<?php echo $url; ?>episode_auto_add.php"
                                            val="<?php echo $series_content['a_id']; ?>">Add Episode Automatically
                                    </option>
                                </select>
                            <?php }?>
                    ...
                    <div class="content">
                        <div class="categories">
                            <a href="#"
                               class="<?php echo $series_content['a_type2']; ?>">English <?php echo $series_content['a_type2']; ?></a>
                        </div>
                        <div class="img"><img src="<?php echo $url;?>images/<?php echo $series_content['a_image']; ?>"/>
                        </div>
                        ...
                        <div class="texts">
                            <?php if (isset($series_content['a_content']) and $series_content['a_content'] != null) {
                                ...
                                <div class="text age"><span>Age Permission: </span> <span class="age"
                                                                                          style="background:<?php echo $color; ?>"><?php echo $series_content['a_age']; ?></span>
                                </div>
                                <div class="text">
                                    <span>Plot Summary:</span> <?php echo $series_content['a_description']; ?></div>
                ...
                <div class="rating_div">
                    ...
                    <div id='rateContainor' style='float: left; width: 200px; margin-left: 20px;'>
                        <div style='float:left;' value="<?php echo $series_content['a_rating']; ?>" id="rateDiv"
                             class='rating'></div>
