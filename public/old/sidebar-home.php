...
<div class="widget" id="featured">
    ...
    $episodess = $ob->get_table("an_episodes",
        "e_coming_date!='' and e_not_yeird!='' order by e_coming_date ASC limit 0,7");
    while ($episode = mysql_fetch_assoc($episodess)) {
        ...
        <div class="block">
            <a href="<?php echo $link;?>">
                <img alt='image' class='eimg' src="<?php echo get_thumbnail('images/' . $ser['a_image'], 50, 75);?>"
                     width="50"
                     height="75"/><!--timthumb.php?src=<?php echo $url;?>images/<?php echo $ser['a_image']; ?>&amp;w=50&amp;h=75-->
                <div class="sub_title"
                     style="width:225px;font-family:helvetica;"><?php echo (strlen($ser['a_title']) < 30) ? $ser['a_title'] : substr($ser['a_title'],
                            0, 30) . "..."; ?><br/>
                    <span style="font-weight:normal;margin-top:5px;float:left"><?php $tit = explode(" ",
                            $episode['e_title']);
