...
if(isset($type[2])){
  switch($type[2]){
    ...
    default:$cont=($episode_content['e_mirror1']==NULL)?$episode_content['e_raw']:$episode_content['e_mirror1'];
  }//end switch
}//end if type
else $cont=($episode_content['e_mirror1']==NULL)?$episode_content['e_raw']:$episode_content['e_mirror1'];
?>
<div id="wrap">
   <div id="content">
		...
		$cont=($episode_content['e_subdub']==NULL)?$episode_content['e_raw']:$episode_content['e_subdub']; ?>
                <div class="block">
                  <a href="<?php echo $main_link; ?>">
                    <div class="tab <?php echo $ser['a_type2']; echo (!(isset($type[2])) or $type[2]=='')?' active':'';?>">Mirror 1</div>
                  </a>
                </div><!--/block-->
             <?php }
	    } else {
...
$(document).ready(function(e){
  $("#vid-close").click(function(e){$("#popup-vid").remove();});
});
</script>
<style>
#popup-vid {
...
//]]>--></script><noscript><a href='http://ads.ad4game.com/www/delivery/dck.php?n=a9f13eb4&amp;cb=INSERT_RANDOM_NUMBER_HERE' target='_blank'><img src='http://ads.ad4game.com/www/delivery/avw.php?zoneid=34472&amp;cb=INSERT_RANDOM_NUMBER_HERE&amp;n=a9f13eb4' border='0' alt='' /></a></noscript>
...
<div id="MarketGidScriptRootC16203">
    <div id="MarketGidPreloadC16203">
        <a id="mg_add16203" href="http://mgid.com/advertisers/?utm_source=widget&utm_medium=text&utm_campaign=add" target="_blank">Place your ad here</a><br>        <a href="http://mgid.com/" target="_blank">Loading...</a>    
    </div>
    <script>
                (function(){
            var D=new Date(),d=document,b='body',ce='createElement',ac='appendChild',st='style',ds='display',n='none',gi='getElementById';
            var i=d[ce]('iframe');i[st][ds]=n;d[gi]("MarketGidScriptRootC16203")[ac](i);try{var iw=i.contentWindow.document;iw.open();iw.writeln("<ht"+"ml><bo"+"dy></bo"+"dy></ht"+"ml>");iw.close();var c=iw[b];}
            catch(e){var iw=d;var c=d[gi]("MarketGidScriptRootC16203");}var dv=iw[ce]('div');dv.id="MG_ID";dv[st][ds]=n;dv.innerHTML=16203;c[ac](dv);
            var s=iw[ce]('script');s.async='async';s.defer='defer';s.charset='utf-8';s.src="//jsc.mgid.com/1/a/1animefushigi.com.16203.js?t="+D.getYear()+D.getMonth()+D.getDate()+D.getHours();c[ac](s);})();
    </script>
</div>
