...
if (isset($_GET['id']) and $_GET['id'] != null) {
    ...
    ?>" method="post" enctype="multipart/form-data">
        <div class="inputNOption" style="width:100%;">
            ...
            <input name="title" value="<?php echo $resss_row['a_title'];
    ?>" type="text" class="textInput"
        ...
        <div class="inputNOption">
            ...
            <input name="episodes" value="<?php echo $resss_row['a_episodes'];
    ?>" type="text" class="textInput"/>
        </div>
        <!--/inputNoption-->
        <div class="inputNOption">
            <div class="smallTitle">Type:</div>
            <input name="type" value="<?php echo $resss_row['a_type'];
    ?>" type="text" class="textInput"/>
        </div>
        <!--/inputNoption-->
        <div class="inputSelectarea">
            ...
            <select class="select" name="type2">
                <option value="subbed" <?php if ($resss_row['a_type2'] == "subbed") {
    echo "selected='selected'";
}
    ?>>subbed
                </option>
                <option value="dubbed" <?php if ($resss_row['a_type2'] == "dubbed") {
    echo "selected='selected'";
}
    ?>>dubbed
                </option>
        ...
        <div class="inputNOption">
            ...
            <input name="age" value="<?php echo $resss_row['a_age'];
    ?>" type="text" class="textInput"/>
        </div>
        <!--/inputNoption-->
        <div class="inputSelectarea">
            ...
            <select class="select" name="status">
                <option value="ongoing" <?php if ($resss_row['a_status'] == "ongoing") {
    echo "selected='selected'";
}
    ?>>Ongoing
                </option>
                <option value="finished" <?php if ($resss_row['a_status'] == "finished") {
    echo "selected='selected'";
}
    ?>>Finished
                </option>
    ...
    ?>
                    <option
                        value="<?php echo $ser['a_id'];
    ?>,<?php echo $ser['a_title'];
    ?>" <?php if ($resss_row['a_prequel'] == $ser['a_id'] . "," . $ser['a_title']) {
    echo "selected='selected'";
}
    ?>><?php echo $ser['a_title'];
    ?></option>
    ...
    ?>
                    <option
                        value="<?php echo $ser['a_id'];
    ?>,<?php echo $ser['a_title'];
    ?>" <?php if ($resss_row['a_sequel'] == $ser['a_id'] . "," . $ser['a_title']) {
    echo "selected='selected'";
}
    ?>><?php echo $ser['a_title'];
    ?></option>
    ...
    ?>
                    <option
                        value="<?php echo $ser['a_id'];
    ?>,<?php echo $ser['a_title'];
    ?>" <?php if ($resss_row['a_story'] == $ser['a_id'] . "," . $ser['a_title']) {
    echo "selected='selected'";
}
    ?>><?php echo $ser['a_title'];
    ?></option>
    ...
    ?>
                    <option
                        value="<?php echo $ser['a_id'];
    ?>,<?php echo $ser['a_title'];
    ?>" <?php if ($resss_row['a_side_story'] == $ser['a_id'] . "," . $ser['a_title']) {
    echo "selected='selected'";
}
    ?>><?php echo $ser['a_title'];
    ?></option>
    ...
    ?>
                    <option
                        value="<?php echo $ser['a_id'];
    ?>,<?php echo $ser['a_title'];
    ?>" <?php if ($resss_row['a_spin_off'] == $ser['a_id'] . "," . $ser['a_title']) {
    echo "selected='selected'";
}
    ?>><?php echo $ser['a_title'];
    ?></option>
    ...
    ?>
                    <option
                        value="<?php echo $ser['a_id'];
    ?>,<?php echo $ser['a_title'];
    ?>" <?php if ($resss_row['a_alternative'] == $ser['a_id'] . "," . $ser['a_title']) {
    echo "selected='selected'";
}
    ?>><?php echo $ser['a_title'];
    ?></option>
    ...
    ?>
                    <option
                        value="<?php echo $ser['a_id'];
    ?>,<?php echo $ser['a_title'];
    ?>" <?php if ($resss_row['a_other'] == $ser['a_id'] . "," . $ser['a_title']) {
    echo "selected='selected'";
}
    ?>><?php echo $ser['a_title'];
    ?></option>
    ...
    ?>
                <div class="inputCheck">
                    <input type="checkbox" class="checkbox" name="genres[]"
                           value="<?php echo $genres_row['g_value'];
    ?>" <?php if (in_array($genres_row['g_value'],
                        $gen)) {
    ...
    ?>/>
                    ...
                    <div class="smallTitle"><?php echo $genres_row['g_value'];
    ?> </div>
                </div><!--/inputCheck-->
            <?php
    ...
    ?>
        ...
        <div class="inputTextarea" style="height:auto">
            ...
            <div class="clear"></div>
            <div class="inputCheck">
                <input type="checkbox" class="checkbox" name="position1"
                       value="recently" <?php if ($resss_row['a_position'] == "recently" or $resss_row['a_position'] == "all") {
    echo "checked='checked'";
}
    ?>/>
                <span></span>
            ...
            <div class="inputCheck">
                <input type="checkbox" class="checkbox" name="position2"
                       value="featured" <?php if ($resss_row['a_position'] == "featured" or $resss_row['a_position'] == "all") {
    echo "checked='checked'";
}
    ?>/>
                <span></span>
        ...
        <div class="inputUpload">
            ...
            <img src="../images/<?php echo $resss_row['a_image'];
    ?>" width="80" height="80"/>
            <input name="img_file" value="" type="file" class="file"/>
            <input name="h_image" value="<?php echo $resss_row['a_image'];
    ?>" type="hidden" class="file"/>
        ...
        <div class="inputTextarea">
            ...
            <textarea class="textarea" name="description"><?php echo $resss_row['a_description'];
    ?></textarea>
        </div>
        <!--/inputTextarea-->
        ...
        <div class="inputTextarea">
            ...
            <textarea class="textarea" name="alternative"><?php echo $resss_row['a_alternative_title'];
    ?></textarea>
        </div>
        <!--/inputTextarea-->
        ...
        <div class="inputTextarea">
            ...
            <textarea class="textarea" name="content"><?php echo $resss_row['a_content'];
    ?></textarea>
        </div>
        <!--/inputTextarea-->
...
<?php
    ...
    header("location:index.php?page=series");
}
?>