...
if (isset($_GET['id']) and $_GET['id'] != null) {
    ...
    ?>" method="post" enctype="multipart/form-data">
        <div class="inputNOption">
            ...
            <input name="bigtitle" value="<?php echo $resss_row['i_bigtitle'];
    ?>" type="text" class="textInput"/>
        </div>
        <!--/inputNoption-->
        <div class="inputNOption">
            <div class="smallTitle">Small Title:</div>
            <input name="smalltitle" value="<?php echo $resss_row['i_smalltitle'];
    ?>" type="text" class="textInput"/>
        </div>
        <!--/inputNoption-->
        <div class="inputNOption">
            <div class="smallTitle">Link: <br/></div>
            <input name="link" value="<?php echo $resss_row['i_link'];
    ?>" type="text" class="textInput"/>
        </div>
        <!--/inputNoption-->
        <div class="inputUpload">
            <div class="smallTitle">Image File (640 * 360):</div>
            <img src="<?php echo "../images/" . $resss_row['i_file'];
    ?>" width="80" height="80"/>
            <input name="img_file" value="" type="file" class="file"/>
            <input name="c_image" value="<?php echo $resss_row['i_file'];
    ?>" type="hidden" class="file"/>
        ...
        <div class="inputTextarea">
            ...
            <textarea class="textarea" name="desc" rows="30"><?php echo $resss_row['i_desc'];
    ?></textarea>
        </div>
        <!--/inputTextarea-->
