    ...
    <body>
        <div id="wrap">
            <div id="header">
                <div id="info_login">
                    <div id="info_u">
                        ...
                        <a href="<?php echo $url; ?>admin/logout.php">log out</a>
                    </div>
                </div>
                <!--/info_login-->
            </div>
            ...
            <div id="content">
                    ...
                    <div id="navBarR">
                        <ul>
                            ...
                            <li class="parent">
                                ...
                                <ul>
                                    <li class="child">
                                        <a href="index.php?page=series_add">
                                            Add Series
                                        </a>
                                    </li>
                                    <li class="child">
                                        <a href="index.php?page=series">
                                            All Series
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <li class="parent">
                                <a href="index.php?page=episodes" onclick="return false">
                                    Episodes
                                </a>
                                <ul>
                                    <li class="child">
                                        <a href="index.php?page=episode_add">
                                            Add Episode
                                        </a>
                                    </li>
                                    <li class="child">
                                        <a href="index.php?page=episodes">
                                            All Episodes
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <li class="parent">
                                <a href="index.php?page=pages" onclick="return false">
                                    Pages
                                </a>
                                <ul>
                                    <li class="child">
                                        <a href="index.php?page=page_add">
                                            Add Page
                                        </a>
                                    </li>
                                    <li class="child">
                            ...
                            <li class="parent">
                                <a href="index.php?page=image" onclick="return false">
                                    Gallery
                                </a>
                                <ul>
                                    <li class="child">
                                        <a href="index.php?page=image_add">
                                            Add Image
                                        </a>
                                    </li>
                                    <li class="child">
                            ...
                            <li class="parent">
                                <a href="index.php?page=cache-purge">
                                    Cache Purge
                                </a>
                            </li>
                        </ul>
                ...
                <div id="rightContent">
                    <?php require_once("includes/" . $pages); ?>
                </div>
                <!--/rightContent-->
            </div>
            <!--/content-->
