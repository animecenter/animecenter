        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                ...
                <div class="embed-responsive embed-responsive-4by3">
                    <IFRAME class="embed-responsive-item" SRC="http://www.mp4upload.com/embed-wi8mkqyrs6k0.html" allowfullscreen="true" FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO width="100%"
                    height="370"></IFRAME>
            ...
            <div class="col-xs-12 text-center">
                ...
                <div class="col-xs-12 col-md-4">
                    <a href="{{ url($anime->slug . '/' . $prevEpisode->slug) }}" class="btn btn-md btn-success"><i class="fa fa-hand-o-left"></i> Prev Episode</a>
                </div>
                @else
                <div class="col-xs-12 col-md-4">
                    <a href="#"></a>
                ...
                @endif
                <div class="col-xs-12 col-md-4">
                    <a href="{{ url($anime->slug) }}" class="btn btn-md btn-success"><i class="fa fa-list"></i> Episode List</a>
                </div>
                @if ($nextEpisode)
                <div class="col-xs-12 col-md-4">
                    <a href="{{ url($anime->slug . '/' . $nextEpisode->slug) }}" class="btn btn-md btn-success"><i class="fa fa-hand-o-right"></i> Next Episode</a>
                </div>
                @else
                <div class="col-xs-12 col-md-4">
                    <a href="#"></a>
