...
<div id="wrap">
        ...
        <div id="left_content">
            <div id="sec2" class="sections">
                ...
                while ($episode = mysql_fetch_assoc($episodes)) {
                    ...
                    ?>
                            <div class="img"><img src="<?php echo $image;
                    ?>"/>

                                <div class="type <?php echo $ser['a_type2'];
                    if ($episode['e_raw'] != null and $episode['e_subdub'] == null) {
                        echo " raw";
                    }
                    ?>">
    ...
    ?><a
                        href="<?php echo $url;
    ?>latest-episodes" title="First Page">&laquo; First</a><?php
