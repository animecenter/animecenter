...
<div id="wrap">
    ...
    ?>
                    <a href="<?php echo $url;
    ?>admin/index.php?page=episode_up&id=<?php echo $episode_content['e_id'];
    ?>"
    ...
    ?>
            ...
            <div class="sections" id="video">
                <div class="video">
                    <div class="title"><?php echo $episode_content['e_title'];
    ?></div>
                        ...
                        <div class="tabs">
                            ...
                            if ($episode_content['e_mirror1'] == '' and $episode_content['e_mirror2'] == '' and $episode_content['e_mirror3'] == '' and $episode_content['e_mirror4'] == '' and $episode_content['e_hd'] == '') {
                                if ($episode_content['e_subdub'] != null or $episode_content['e_subdub'] != '') {
                                    ...
                                    echo(! (isset($type[2])) or $type[2] == '') ? ' active' : '';
                                    ?>">Mirror 1
                                            </div>
                                        </a>
                                    </div><!--/block-->
    ...
    echo((isset($type[2]) and $type[2] == 'raw')
                                                or $episode_content['e_subdub'] == null) ? ' active' : '';
    ?> raw">RAW
                                            </div>
                                        </a>
                                    </div><!--/block-->
    ...
    ?>/hd">
                                            <div class="tab <?php echo $ser['a_type2'];
    echo(isset($type[2]) and $type[2] == 'hd') ? ' active' : '';
    ?> mirror">
                                                Mirror HD
                                            </div>
                                        </a>
    ...
    ?>css/js/countdown.js"></script>
                        <div class="date_con">
                            <script>
                                var myCountdown1 = new Countdown({
                                    time: <?php echo $total_s;
    ?>, // 86400 seconds = 1 day
                                    width: 250,
                                    height: 60,
                                    rangeHi: "day",
                        ...
                        <div class="date_img"><img src="<?php echo $url . "/images/" . $ser['a_image'];
    ?>"/></div>
    ...
    ?>
                ...
                <div class="rating_div">
                    <div class="views_value view_episode" id="<?=$episode_content['e_id'];
    ?>"></div>
                ...
                <div class="links_btns">
                    <div class="fb-like" style="margin-top:3px;"
                         data-href="<?php echo $url . "watch/" . str_replace(" ", "-",
                                 strtolower($episode_content['e_title']));
    ...
    ?>
            ...
            <div class="bottom_text">
                You are going to <b>Watch <?php echo $episode_content['e_title'];
    ?> </b> in <b> English
                    Subbed/Dubbed </b>from <b><?php echo $ser['a_title'];
    ?> </b> Anime. Watch
                <b><?php echo $episode_content['e_title'];
    ?> </b>online and the other episodes of
                <b><?php echo $ser['a_title'];
    ?> </b>with High Quality Streaming for <b>FREE</b>
            </div>
