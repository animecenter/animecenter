...
if (isset($_GET['filter']) and $_GET['filter'] != null) {
    ...
    $seriess = $ob->get_table("an_series",
        "a_type2='dubbed' and a_title like '" . $s . "%' order by a_title ASC limit " . $start . ", 20");
} else {
    ...
    $seriess = $ob->get_table("an_series",
        "a_type2='dubbed' and a_title like 'a%' order by a_title ASC limit " . $start . ", 20");
}
?>
<div id="wrap">
    <div id="content">
    ...
    ?><a
                        href="<?php echo $url;
    ?>browse_a-z-dubbed" title="First Page">&laquo; First</a><?php
