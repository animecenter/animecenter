...
<script type="text/javascript" src="css/js/core.js"></script><!--This Include all Javascript Core Functions-->
...
<div id="wrap">
    <div id="header">
        <div id="info_login">
        <div id="info_u">Welcome <?php echo $_SESSION['u_username']; ?> <a href="<?php echo $url; ?>admin/logout.php">log out</a></div>
        </div><!--/info_login-->
    </div><!--/header-->
