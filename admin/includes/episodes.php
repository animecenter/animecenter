...
<li><?php echo $res_row['e_title']; ?><a href="index.php?page=episode_up&id=<?php echo $res_row['e_id']; ?>" class="prevBT update">update</a>
<a href="includes/del-core.php?name=episode&id=<?php echo $res_row['e_id']; ?>" class="prevBT del">delete</a></li>
