...
if (isset($_GET['id']) and $_GET['id'] != null) {
    ...
    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
        <div class="inputNOption" style="width:100%;">
            ...
            <input name="title" value="<?php echo $resss_row['a_title']; ?>" type="text" class="textInput"
                   style="width:80%;"/>
        </div>
        <!--/inputNoption-->
        ...
        <div class="inputSelectarea">
            ...
            <select class="select" name="prequel">
                ...
                <?php foreach ($series as $ser) { ?>
                    <option
                        value="<?php echo $ser['a_id']; ?>,<?php echo $ser['a_title']; ?>" <?php if ($resss_row['a_prequel'] == $ser['a_id'] . "," . $ser['a_title']) {
                        echo "selected='selected'";
                    } ?>><?php echo $ser['a_title']; ?></option>
                <?php } ?>
            </select>
        ...
        <div class="inputSelectarea">
            ...
            <select class="select" name="sequel">
                ...
                <?php foreach ($series as $ser) { ?>
                    <option
                        value="<?php echo $ser['a_id']; ?>,<?php echo $ser['a_title']; ?>" <?php if ($resss_row['a_sequel'] == $ser['a_id'] . "," . $ser['a_title']) {
                        echo "selected='selected'";
                    } ?>><?php echo $ser['a_title']; ?></option>
                <?php } ?>
            </select>
        ...
        <div class="inputSelectarea">
            ...
            <select class="select" name="story">
                ...
                <?php foreach ($series as $ser) { ?>
                    <option
                        value="<?php echo $ser['a_id']; ?>,<?php echo $ser['a_title']; ?>" <?php if ($resss_row['a_story'] == $ser['a_id'] . "," . $ser['a_title']) {
                        echo "selected='selected'";
                    } ?>><?php echo $ser['a_title']; ?></option>
                <?php } ?>
            </select>
        ...
        <div class="inputSelectarea">
            ...
            <select class="select" name="s_story">
                ...
                <?php foreach ($series as $ser) { ?>
                    <option
                        value="<?php echo $ser['a_id']; ?>,<?php echo $ser['a_title']; ?>" <?php if ($resss_row['a_side_story'] == $ser['a_id'] . "," . $ser['a_title']) {
                        echo "selected='selected'";
                    } ?>><?php echo $ser['a_title']; ?></option>
                <?php } ?>
            </select>
        ...
        <div class="inputSelectarea">
            ...
            <select class="select" name="spin_off">
                ...
                <?php foreach ($series as $ser) { ?>
                    <option
                        value="<?php echo $ser['a_id']; ?>,<?php echo $ser['a_title']; ?>" <?php if ($resss_row['a_spin_off'] == $ser['a_id'] . "," . $ser['a_title']) {
                        echo "selected='selected'";
                    } ?>><?php echo $ser['a_title']; ?></option>
                <?php } ?>
            </select>
        ...
        <div class="inputSelectarea">
            ...
            <select class="select" name="alternative_2">
                ...
                <?php foreach ($series as $ser) { ?>
                    <option
                        value="<?php echo $ser['a_id']; ?>,<?php echo $ser['a_title']; ?>" <?php if ($resss_row['a_alternative'] == $ser['a_id'] . "," . $ser['a_title']) {
                        echo "selected='selected'";
                    } ?>><?php echo $ser['a_title']; ?></option>
                <?php } ?>
            </select>
        ...
        <div class="inputSelectarea">
            ...
            <select class="select" name="other">
                ...
                <?php foreach ($series as $ser) { ?>
                    <option
                        value="<?php echo $ser['a_id']; ?>,<?php echo $ser['a_title']; ?>" <?php if ($resss_row['a_other'] == $ser['a_id'] . "," . $ser['a_title']) {
                        echo "selected='selected'";
                    } ?>><?php echo $ser['a_title']; ?></option>
                <?php } ?>
            </select>
            ...
            <?php while ($genres_row = mysql_fetch_assoc($genres)) { ?>
                <div class="inputCheck">
                    <input type="checkbox" class="checkbox" name="genres[]"
                           value="<?php echo $genres_row['g_value']; ?>" <?php if (in_array($genres_row['g_value'],
                        $gen)) {
