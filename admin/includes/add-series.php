...
<div class="inputSelectarea">
        ...
        <option value="<?php echo $ser['a_id']; ?>,<?php echo $ser['a_title']; ?>"><?php echo $ser['a_title']; ?></option>
		<?php } ?>
        </select>
...
<div class="clear"></div>
   <?php while($genres_row=mysql_fetch_assoc($genres)) {?>
    ...
    <input type="checkbox" class="checkbox" name="genres[]" value="<?php echo $genres_row['g_value']; ?>"/>
    <span></span>
