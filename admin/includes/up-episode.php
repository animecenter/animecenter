...
if (isset($_GET['id']) and $_GET['id'] != null) {
    ...
    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="inputNOption" style="width:100%;">
            ...
            <input name="title" value="<?php echo $resss_row['e_title'];?>" type="text" class="textInput"
                   style="width:80%;"/>
        </div>
        <!--/inputNoption-->
        <div class="inputSelectarea">
            ...
            <select class="select" name="series">
                <?php foreach ($series as $ser) { ?>
                    <option value="<?php echo $ser['a_id']; ?>" <?php if ($resss_row['e_series'] == $ser['a_id']) {
        ...
        <div class="inputNOption" style="">
            <div class="smallTitle">Coming Date: <a href="#" class="prevBT set_date" val="<?php echo date('Y-m-d H:i:s',
                    strtotime(date("Y-m-d H:i:s") . "+7 day"));?>">Set Date</a></div>
            <input name="coming_date" value="<?php echo $resss_row['e_coming_date'];?>" type="text" class="textInput"
                   style=""/>
        </div>
        <!--/inputNoption-->
        <div class="clear"></div>
