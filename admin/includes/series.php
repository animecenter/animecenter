...
<ul class="list_ob">
    <?php while ($res_row = mysql_fetch_assoc($res)) { ?>
        <li><?php echo $res_row['a_title']; ?><a href="index.php?page=series_up&id=<?php echo $res_row['a_id']; ?>"
                                                 class="prevBT update">update</a>
            <a href="includes/del-core.php?name=series&id=<?php echo $res_row['a_id']; ?>" class="prevBT del">delete</a>
        </li>
