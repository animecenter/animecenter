...
<li><?php echo $res_row['i_bigtitle']; ?><a href="index.php?page=image_up&id=<?php echo $res_row['i_id']; ?>" class="prevBT update">update</a>
<a href="includes/del-core.php?name=image&id=<?php echo $res_row['i_id']; ?>" class="prevBT del">delete</a></li>
